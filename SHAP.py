...
# print which actions the blue agent performed
print_actions = False

# Do Shap Analysis
shap_analysis = True

# Perform Reward Decomposition and plot number_episodes_plot episodes
rew_decomp = True
number_episodes_plot = 1
if rew_decomp & (number_episodes_plot > MAX_EPS):
    raise ValueError("You can't draw more episodes than were performed")
#-----------------------------------------------------
...
# Analyse & print actions of the blue agent ---------------------------------------------------------------------------
if print_actions:
    # Semantic Shit
    semantic_labels = {
